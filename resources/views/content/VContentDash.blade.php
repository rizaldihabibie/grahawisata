...
<!-- <img src="<?php echo URL::asset('../storage/app/image/profile_picture/profile_pic_1.jpeg');?>" alt=""/> -->
<div class="row">
    <div class="col-md-3">
        ...
        <div class="widget widget-default widget-carousel">
            <div class="owl-carousel" id="owl-example">
                <div>                                    
                    <div class="widget-title">Total Layanan</div>                                                                        
                    <div class="widget-subtitle">27/08/2014 15:23</div>
                    <div class="widget-int">3,548</div>
                </div>
                <div>                                    
                    <div class="widget-title">Cuci Mobil</div>
...
<!-- START DASHBOARD CHART -->
    <div class="row">
        <div class="col-md-12 col-xs-12"> 
            <div class="ct-series-primer" style="margin-bottom:-5px;" id="chart-pemasukan-dash"></div> 
        </div>                                              
    </div>          
<!-- END DASHBOARD CHART -->
@stop
